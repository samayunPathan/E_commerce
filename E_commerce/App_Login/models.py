...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    is_staff=models.BooleanField(
        ...
        default=False,
        help_text=gettext_lazy('Disignates whether the user can log in this site')
    )

    is_active=models.BooleanField(
        gettext_lazy('active status'),
        default=True,
        help_text=gettext_lazy('Disignates whether this user should be treated as active. Unselect this instead of deleting account')
    )
